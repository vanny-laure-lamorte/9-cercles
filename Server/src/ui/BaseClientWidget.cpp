...
BaseClientWidget::BaseClientWidget(QWidget *parent,
    ...
    : QWidget(parent),
      ...
      displayInfoTitle(displayInfoTitle)
{
}
...
void BaseClientWidget::addClient(const QString &socketId)
{
    ...
    btn->setStyleSheet("border-radius:5px; padding:4px 8px; color:#faa4a4; "
                       "background-color:#2c0c0c; font-size:14px; font-family:Calibri;");
